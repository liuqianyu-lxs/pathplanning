...
def train_agent(agent, episodes, render_every, base_dir, dirs):
    ...
    current_obstacle_ratio = (0.05, 0.07)
    current_blind_ratio = 0.03
    ...
    for episode in range(1, episodes + 1):
        if episode % CURRICULUM_STEPS == 0:
            ...
            current_obstacle_ratio = (current_obstacle_ratio[0], min(current_obstacle_ratio[1] + 0.01, 0.15))
