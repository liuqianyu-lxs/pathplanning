...
def generate_map(grid_size=100, obstacle_ratio_range=(0.08, 0.12), blind_ratio=0.08, blob_radius=3):
...
def generate_test_maps(count=20, difficulties=None):
    if difficulties is None:
        difficulties = [(100, (0.08, 0.12), 0.08) for _ in range(count)]
